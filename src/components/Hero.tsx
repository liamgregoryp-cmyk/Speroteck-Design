      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className={`transition-all duration-[1.5s] ease-out ${loaded ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
          <div className="relative">
            <<SperoteckLogo size={360} className="animate-logo-spin drop-shadow-[0_0_60px_hsl(82,75%,42%,0.3)]" /> className="animate-logo-spin drop-shadow-[0_0_60px_hsl(82,75%,42%,0.3)]" />
            {/* Logo ring */}
